...
// The temporary wallet file can be renamed as wallet.vectorium and used for testing with vectoriumd.
//
#if 0
TEST(founders_reward_test, create_testnet_2of3multisig) {
    ...
    bool fFirstRun;
    auto pWallet = std::make_shared<CWallet>("wallet.vectorium");
