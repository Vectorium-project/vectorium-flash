...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Vectorium vectorium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vectorium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Vectorium transaction") + "\n" +
              "  vectorium-tx [options] -create [commands]   " + _("Create hex-encoded Vectorium transaction") + "\n" +
              "\n";
        ...
        strUsage += HelpMessageOpt("sign=HEIGHT:SIGHASH-FLAGS", _("Add vectorium or more signatures to transaction") + ". " +
