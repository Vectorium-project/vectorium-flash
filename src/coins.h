...
public:
    ...
    void CalcMaskSize(unsigned int &nBytes, unsigned int &nNonvectoriumBytes) const;
...
public:
     ...
     * @return	Sum of value of all inputs (scriptSigs), (positive valueBalance or vectorium) and JoinSplit vpub_new
     */
