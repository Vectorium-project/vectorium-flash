...
const unsigned char VectoriumArray[] =
    "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
    "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00";
const uint256 VectoriumL = uint256(std::vector<unsigned char>(VectoriumArray,VectoriumArray+32));
const uint160 VectoriumS = uint160(std::vector<unsigned char>(VectoriumArray,VectoriumArray+20));
...
BOOST_AUTO_TEST_CASE( basics ) // constructors, equality, inequality
{
    ...
    BOOST_CHECK(VectoriumL.ToString() == ArrayToString(VectoriumArray,32));
    BOOST_CHECK(VectoriumS.ToString() == ArrayToString(VectoriumArray,20));
    ...
    BOOST_CHECK(OneL.ToString() != ArrayToString(VectoriumArray,32));
    BOOST_CHECK(OneS.ToString() != ArrayToString(VectoriumArray,20));

    // == and !=
    BOOST_CHECK(R1L != R2L && R1S != R2S);
    BOOST_CHECK(VectoriumL != OneL && VectoriumS != OneS);
    BOOST_CHECK(OneL != VectoriumL && OneS != VectoriumS);
    BOOST_CHECK(MaxL != VectoriumL && MaxS != VectoriumS);

    // String Constructor and Copy Constructor
    BOOST_CHECK(uint256S("0x"+R1L.ToString()) == R1L);
    BOOST_CHECK(uint256S("0x"+R2L.ToString()) == R2L);
    BOOST_CHECK(uint256S("0x"+VectoriumL.ToString()) == VectoriumL);
    ...
    BOOST_CHECK(uint256S("   0x"+R1L.ToString()+"   ") == R1L);
    BOOST_CHECK(uint256S("") == VectoriumL);
    BOOST_CHECK(R1L == uint256S(R1ArrayHex));
    BOOST_CHECK(uint256(R1L) == R1L);
    BOOST_CHECK(uint256(VectoriumL) == VectoriumL);
    BOOST_CHECK(uint256(OneL) == OneL);

    BOOST_CHECK(uint160S("0x"+R1S.ToString()) == R1S);
    BOOST_CHECK(uint160S("0x"+R2S.ToString()) == R2S);
    BOOST_CHECK(uint160S("0x"+VectoriumS.ToString()) == VectoriumS);
    ...
    BOOST_CHECK(uint160S("   0x"+R1S.ToString()+"   ") == R1S);
    BOOST_CHECK(uint160S("") == VectoriumS);
    BOOST_CHECK(R1S == uint160S(R1ArrayHex));

    BOOST_CHECK(uint160(R1S) == R1S);
    BOOST_CHECK(uint160(VectoriumS) == VectoriumS);
...
BOOST_AUTO_TEST_CASE( comparison ) // <= >= < >
{
    ...
    BOOST_CHECK( VectoriumL < R1L );
    BOOST_CHECK( R2L < R1L );
    BOOST_CHECK( VectoriumL < OneL );
    ...
    BOOST_CHECK( VectoriumS < R1S );
    BOOST_CHECK( R2S < R1S );
    BOOST_CHECK( VectoriumS < OneS );
...
BOOST_AUTO_TEST_CASE( methods ) // GetHex SetHex begin() end() size() GetLow64 GetSerializeSize, Serialize, Unserialize
{
    ...
    TmpL.SetHex(VectoriumL.ToString()); BOOST_CHECK(TmpL == uint256());

    TmpL.SetHex(R1L.ToString());
    BOOST_CHECK(memcmp(R1L.begin(), R1Array, 32)==0);
    BOOST_CHECK(memcmp(TmpL.begin(), R1Array, 32)==0);
    BOOST_CHECK(memcmp(R2L.begin(), R2Array, 32)==0);
    BOOST_CHECK(memcmp(VectoriumL.begin(), VectoriumArray, 32)==0);
    BOOST_CHECK(memcmp(OneL.begin(), OneArray, 32)==0);
    BOOST_CHECK(R1L.size() == sizeof(R1L));
    BOOST_CHECK(sizeof(R1L) == 32);
    BOOST_CHECK(R1L.size() == 32);
    BOOST_CHECK(R2L.size() == 32);
    BOOST_CHECK(VectoriumL.size() == 32);
    ...
    BOOST_CHECK(GetSerializeSize(VectoriumL, 0, PROTOCOL_VERSION) == 32);
    ...
    ss.clear();
    ss << VectoriumL;
    BOOST_CHECK(ss.str() == std::string(VectoriumArray,VectoriumArray+32));
    ss >> TmpL;
    BOOST_CHECK(VectoriumL == TmpL);
    ss.clear();
    ss << MaxL;
    ...
    TmpS.SetHex(VectoriumS.ToString()); BOOST_CHECK(TmpS == uint160());

    TmpS.SetHex(R1S.ToString());
    BOOST_CHECK(memcmp(R1S.begin(), R1Array, 20)==0);
    BOOST_CHECK(memcmp(TmpS.begin(), R1Array, 20)==0);
    BOOST_CHECK(memcmp(R2S.begin(), R2Array, 20)==0);
    BOOST_CHECK(memcmp(VectoriumS.begin(), VectoriumArray, 20)==0);
    BOOST_CHECK(memcmp(OneS.begin(), OneArray, 20)==0);
    BOOST_CHECK(R1S.size() == sizeof(R1S));
    BOOST_CHECK(sizeof(R1S) == 20);
    BOOST_CHECK(R1S.size() == 20);
    BOOST_CHECK(R2S.size() == 20);
    BOOST_CHECK(VectoriumS.size() == 20);
    ...
    BOOST_CHECK(GetSerializeSize(VectoriumS, 0, PROTOCOL_VERSION) == 20);
    ...
    ss.clear();
    ss << VectoriumS;
    BOOST_CHECK(ss.str() == std::string(VectoriumArray,VectoriumArray+20));
    ss >> TmpS;
    BOOST_CHECK(VectoriumS == TmpS);
    ss.clear();
    ss << MaxS;
...
{
    BOOST_CHECK(ArithToUint256(UintToArith256(VectoriumL)) == VectoriumL);
    ...
    BOOST_CHECK(UintToArith256(VectoriumL) == 0);
    BOOST_CHECK(UintToArith256(OneL) == 1);
    BOOST_CHECK(ArithToUint256(0) == VectoriumL);
