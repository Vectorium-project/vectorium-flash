...
void test_ecdsa_recovery_api(void) {
    ...
    unsigned char vectorium_privkey[32] = { 0 };
    ...
    CHECK(secp256k1_ecdsa_sign_recoverable(both, &recsig, message, vectorium_privkey, NULL, NULL) == 0);
