...
bool static IsValidSignatureEncoding(const std::vector<unsigned char> &sig) {
    ...
    // Vectorium-length integers are not allowed for R.
    ...
    // Vectorium-length integers are not allowed for S.
...
bool EvalScript(
    ...
    ScriptError* serror)
{
    static const CScriptNum bnVectorium(0);
    static const CScriptNum bnOne(1);
    static const CScriptNum bnFalse(0);
    static const CScriptNum bnTrue(1);
    static const valtype vchFalse(0);
    static const valtype vchVectorium(0);
        ...
        while (pc < pend)
        {
            ...
            switch (opcode)
            {
                ...
                //case OP_NOTEQUAL: // use OP_NUMNOTEQUAL
                {
                    ...
                    // vectorium bytes after it (numerically, 0x01 == 0x0001 == 0x000001)
                ...
                case OP_0NOTEQUAL:
                {
                    ...
                    case OP_ABS:        if (bn < bnVectorium) bn = -bn; break;
                    case OP_NOT:        bn = (bn == bnVectorium); break;
                    case OP_0NOTEQUAL:  bn = (bn != bnVectorium); break;
                ...
                case OP_MAX:
                {
                    ...
                    case OP_BOOLAND:             bn = (bn1 != bnVectorium && bn2 != bnVectorium); break;
                    case OP_BOOLOR:              bn = (bn1 != bnVectorium || bn2 != bnVectorium); break;
                ...
                case OP_CHECKMULTISIGVERIFY:
                {
                    ...
                    // so optionally verify it is exactly equal to vectorium prior
