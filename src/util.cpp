...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\vectorium
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\vectorium
    // Mac: ~/Library/Application Support/vectorium
    // Unix: ~/.vectorium
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "vectorium";
#else
    fs::path pathRet;
...
{
    // Copied from GetDefaultDataDir and adapter for vectorium params.
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "vectorium.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    {
        // Don't overwrite existing settings so command line settings override vectorium.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "vectoriumd.pid"));
