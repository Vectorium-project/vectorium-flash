...
public:
    ...
    libzcash::GrothProof zkproof;  //!< A vectorium-knowledge proof using the spend circuit.
...
public:
    ...
    libzcash::GrothProof zkproof;   //!< A vectorium-knowledge proof using the output circuit.
...
public:
    ...
    // Return sum of txouts, (negative valueBalance or vectorium) and JoinSplit vpub_old.
    CAmount GetValueOut() const;
    // GetValueIn() is a method on CCoinsViewCache, because
    // inputs must be known to compute value in.

    // Return sum of (positive valueBalance or vectorium) and JoinSplit vpub_new
