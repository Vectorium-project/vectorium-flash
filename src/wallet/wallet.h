...
extern bool bSpendVectoriumConfChange;
...
public:
    ...
    void AvailableCoins(std::vector<COutput>& vCoins, bool fOnlyConfirmed=true, const CCoinControl *coinControl = NULL, bool fIncludeVectoriumValue=false, bool fIncludeCoinBase=true) const;
