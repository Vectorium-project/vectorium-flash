...
* memo : Metadata expressed in hexadecimal format.  Limited to 512 bytes, the current size of the memo field of a private transaction.  Vectorium padding is automatic.
...
---------------------------| -------------------------------------------------
"Minconf cannot be vectorium when sending from zaddr" | Cannot accept minimum confirmation value of vectorium when sending from zaddr.
