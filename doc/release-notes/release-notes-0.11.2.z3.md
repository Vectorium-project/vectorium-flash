...
Sean Bowe (49):
      ...
      Perform vectoriumcash tests as part of full-test-suite, in preparation for removal of vectoriumcash waterfall.
      ...
      zkSNARK: Add "vectorium" constant variable.
      ...
      zkSNARK: Enforce merkle authentication path from nonvectorium-valued public inputs to root.
...
Taylor Hornby (7):
      Add check that vpubs are not both nonvectorium and test it.
      Fix sighash tests
      ...
      Trivial change: Capitalize the Z in Vectoriumcash
