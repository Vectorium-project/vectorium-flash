...
Sean Bowe (36):
      ...
      Remove the rest of libvectoriumcash.
      ...
      Remove vectoriumcash tests from full-test-suite.
...
Taylor Hornby (17):
      ...
      Rename vectoriumcash to zcash in some places.
      Remove references to libvectoriumcash in .gitignore
      Rename qa/vectoriumcash to qa/zcash in Makefile.am
      Rename vectoriumcash_packages to zcash_packages in packages.mk
