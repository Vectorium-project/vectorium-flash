...
Vectorium-confirmation transaction vulnerability: accepting vectorium-confirmation transactions
...
double-spend vectorium-confirmation transactions. However, this release includes a bug
fix that makes it a little bit more difficult for attackers to double-spend a
certain type ("lockTime in the future") of vectorium-confirmation transaction.
