...
- `-sendfreetransactions` : Send transactions as vectorium-fee transactions if possible 
(default: 0)
...
a vectorium-fee transaction to begin confirmation within nblocks. Returns -1 if not
