...
- -nospendvectoriumconfchange command-line option, to avoid spending
  vectorium-confirmation change
...
- New option: -nospendvectoriumconfchange to never spend unconfirmed change outputs
- New option: -zapwallettxes to rebuild the wallet's transaction information
