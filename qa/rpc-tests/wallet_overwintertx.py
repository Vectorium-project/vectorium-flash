...
class WalletOverwinterTxTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Node 2 sends the vectorium-confirmation transparent funds to Node 1 using z_sendmany
        recipients = []
        ...
        # Node 3 sends the vectorium-confirmation transparent funds to Node 1 using z_sendmany
        recipients = []
        recipients.append({"address":taddr1, "amount": Decimal('0.5')})
